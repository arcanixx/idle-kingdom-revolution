  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-md">Tactical formation battles, idle progression, zero stamina gating.</p>
        ...
        <div className="grid grid-cols-3 gap-6 pt-12 max-w-2xl">
          <div><h3 className="font-semibold">Tactical Battles</h3><p className="text-sm text-muted-foreground">3x3 formation with synergies</p></div>
          <div><h3 className="font-semibold">Idle Progression</h3><p className="text-sm text-muted-foreground">No energy system, play freely</p></div>
          <div><h3 className="font-semibold">Fair & Free</h3><p className="text-sm text-muted-foreground">Cosmetic-only, zero P2W</p></div>
        </div>
      </main>
    </div>
  );
