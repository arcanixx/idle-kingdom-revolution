...
| Ranger | Bow | Curve and draw length fixed; only material/string glow evolve — **CONFIRMED** by `02_POC/HUMAN_IRON_LEGION_RANGER_V1.md` (2026-06-27): recurve bow held its curve and proportions across all six rarities with no shape drift |
